								...
								<div class="form-row mb-1">
									...
									<div class="col">
										...
										<span class="form-text small device<?php echo $devicenum; ?>-option device<?php echo $devicenum; ?>-option-mqtt hide">
											...
											openWB/LegacySmartHome/Devices/2/ReqRelay = 1<br>
											openWB/LegacySmartHome/Devices/2/Ueberschuss = in Watt<br>
											Wenn Ausschaltbedingung erreicht<br>
											openWB/LegacySmartHome/Devices/2/ReqRelay = 0<br>
											openWB/LegacySmartHome/Devices/2/Ueberschuss = in Watt<br>
											...
											openWB/set/LegacySmartHome/config/set/Devices/2/mode <br>
											Mode steuert das Gerät (1 = manueller Modus, 0 = automatischer Modus)<br>
											openWB/set/LegacySmartHome/config/set/Devices/2/device_manual_control<br>
											device_manual_control steuert das Ferät im manuellen Modus (1 = ein, 0 = aus)<br>
											openWB/set/LegacySmartHome/config/set/Devices/2/manueb = vorgebener Überschuss in Watt ohne Nachkommastellen<br>
