...
export default {
	...
	data() {
		return {
			...
			helpText: [
				{ text: ""},
				{ text: '<p>Auswahl, dass die Zugangskontrolle aktiv ist.<br /><br />Dadurch lassen sich prinzipiell drei verschiedene Szenarien realisieren.<br />Wird hier die Identifikation aktiviert, und im nächsten Fenster der entsprechende ID-Tag im Ladepunkt-Profil eingetragen, dann kann dadurch dieser Ladepunkt mit diesem ID-Tag entsperrt werden und das zuletzt zugeordnete Fahrzeug startet den Ladevorgang an diesem Ladepunkt, wenn ein aktiver Lademodus (Sofortladen, PV- oder Zielladen) im Lade-Profil ausgewählt wurde.<br /><br />Ist derselbe ID-Tag auch bei einem Fahrzeug hinterlegt, dann wird der Ladepunkt entsperrt und das dem ID-Tag zugeordnete Fahrzeug startet den Ladevorgang mit dem entsprechenden Lade-Profil.<br /><br />Wird die Option Zugangskontrolle - Freigabe durch ID-Tags im Ladepunkt-Profil nicht aktiviert, dann startet das dem ID-Tag zugeordnete Fahrzeug mit entsprechendem Lade-Profil den Ladevorgang, insofern der Ladepunkt nicht gesperrt ist.</p>.<br /><p class="font-weight-bold">Änderungen werden nur bei klicken auf speichern wirksam</p>'},
				{ text: '<p>Unter Ladepunkt-Profile bei einem Ladepunkt-Profil unter dem Punkt Zugangskontrolle kann die Freigabe durch ID-Tags aktiviert werden.<br /><br />Dadurch kann der Ladepunkt in Kombination mit der Option Sperren nach Abstecken oder bei manueller Sperrung nur durch den zugehörigen ID-Tag entsperrt werden.<br /><br />Diese Option nur dann aktivieren, wenn der Ladepunkt tatsächlich nur durch die hier hinterlegten ID-Tags entsperrt werden soll.<br />Diese Option ist vor allem sinnvoll in Kombination mit Sperre nach Abstecken und Standard nach Abstecken im Fahrzeug Lade-Profil.<br /><br />Anschließend ist den Ladepunkten das entsprechende Ladepunkt-Profil unter Ladepunkte zuzuordnen</p>.<br /><p class="font-weight-bold">Änderungen werden nur bei klicken auf speichern wirksam</p>'},
				{ text: '<p>Unter Lade-Profile kann der aktive Lademodus eingestellt werden und die zwei Optionen Sperre nach Abstecken oder Standard nach Abstecken sind auswählbar.<br /><br />Die Option Sperre nach Abstecken ist vor allem dann sinnvoll, wenn im Ladepunkt-Profil die Zugangskontrolle aktiviert ist und dort ein ID-Tag hinterlegt ist, welcher gleichzeitig in einem Fahrzeug eingetragen ist.<br /> Ist dieser ID-Tag dann im entsprechenden Fahrzeug hinterlegt, wird der Ladepunkt entsperrt und das dem ID-Tag zugeordnete Fahrzeug (mit dessen Ladeprofil) wird geladen.<br /><br />Also der im Ladepunkt-Profil und im Fahrzeug hinterlegte ID-Tag ist identisch.<br /><br />Alternativ kann hier auch Standard nach Abstecken ausgewählt werden, wobei dann das Standard-Lade-Profil nach Abstecken ausgewählt wird. Wird im Standard-Lade-Profl bei aktiver Lademodus Stop ausgewählt, wird bei erneutem Anstecken eines Fahrzeugs der Ladevorgang verhindert.<br /><br />Diese Option macht nur Sinn, wenn ein ID-Tag in einem Fahrzeug hinterlegt wird, wodurch dann nach Abscannen des ID-Tags das diesem Fahrzeug zugeordnete Fahrzeug mit entsprechendem Lade-Profil ausgewählt wird, welches einen aktiven Lademodus hat, wodurch dann dieses Fahrzeug den Ladevorgang startet.<br /><br />Bei Auswahl Standard nach Abstecken macht es keinen Sinn im Ladepunkt-Profil die Zugangskontrolle zu aktivieren und einen ID-Tag einzutragen.</p>.<br /><p class="font-weight-bold">Änderungen werden nur bei klicken auf speichern wirksam</p>' },			
				{ tex: ''},
			],
		};
	},
