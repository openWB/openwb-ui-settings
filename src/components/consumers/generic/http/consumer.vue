<template>
  <div class="consumer-generic-http">
    ...
    <openwb-base-text-input
      ...
      subtype="text"
      :model-value="consumer.configuration.switch_on_path"
    ...
    <openwb-base-text-input
      ...
      subtype="text"
      :model-value="consumer.configuration.switch_off_path"
    ...
    <openwb-base-text-input
      ...
      subtype="text"
      :model-value="consumer.configuration.set_power_limit_path"
...
export default {
  ...
  computed: {
    usageType() {
      return this.consumer.consumerUsage?.type;
    },
    showSwitchPaths() {
