<template>
  <div class="consumer-generic-json">
    ...
    <openwb-base-text-input
      ...
      title="jq switch on"
      subtype="text"
      :model-value="consumer.configuration.jq_switch_on"
    ...
    <openwb-base-text-input
      ...
      title="jq switch off"
      subtype="text"
      :model-value="consumer.configuration.jq_switch_off"
    ...
    <openwb-base-text-input
      ...
      subtype="text"
      :model-value="consumer.configuration.jq_set_power_limit"
