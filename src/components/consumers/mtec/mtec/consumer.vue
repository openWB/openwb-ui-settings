<template>
  <div class="consumer-mtec">
    <openwb-base-heading> Einstellungen für M-TEC Wärmepumpe </openwb-base-heading>
    <openwb-base-alert subtype="info">
      Am Wärmepumpenregler muss "Modul Type" auf "Virtual" und "WMZ Modus" auf "Analog" gestellt werden (siehe
      M-TEC-Anleitung zur PV-Überschussnutzung).
    </openwb-base-alert>
