<template>
	<openwb-base-card subtype="danger" :collapsible="true" :collapsed="true">
		<template #header>
		...
		<openwb-base-text-input title="Export" readonly class="text-right text-monospace" step="0.001" unit="kWh"
			:model-value="formatNumberTopic(
					...
					" />
		<openwb-base-text-input title="Import" readonly class="text-right text-monospace" step="0.001" unit="kWh"
			:model-value="formatNumberTopic(
		...
		<openwb-base-text-input title="Wirkleistung" readonly class="text-right text-monospace" step="0.001" unit="kW"
			:model-value="formatNumberTopic(
				...
				" />
		<openwb-base-text-input title="Netzfrequenz" readonly class="text-right text-monospace" step="0.001" unit="Hz"
			:model-value="formatNumberTopic(
