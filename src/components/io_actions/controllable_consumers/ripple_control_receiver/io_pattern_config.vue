<template>
  <table class="w-100">
    ...
    <tr>
      ...
      <!-- <th
        v-for="key in Object.keys(ioDevice.input.analog)"
        :key="key"
        class="input-header"
      >
        {{ key }}
    ...
    >
      ...
      <!-- ToDo: add analog inputs -->
      <!-- <td
        v-for="deviceInputKey in Object.keys(ioDevice.input.analog)"
        :key="deviceInputKey"
        class="input"
      >
        {{ deviceInputKey }}
...
export default {
  ...
  computed: {
    ...
    numInputs() {
      ...
      // ToDo: Add analog inputs
      // return Object.keys(this.ioDevice.input.digital).length + Object.keys(this.ioDevice.input.analog).length;
    },
  },
  methods: {
    getIcon(input) {
