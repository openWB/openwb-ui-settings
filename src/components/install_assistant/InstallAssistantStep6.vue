<template>
  ...
  >
    <template #help>
      ...
      <p>
        Bei openWBs ab Werk kann hier bereits ein Ladepunkt eingetragen
        sein.
      </p>
      <p>
        Nachfolgend werden die Eigenschaften des Ladepunktes wie
        IP-Adresse und elektrischer Anschluss definiert. Die meisten
        openWB werden 3-phasig angeschlossen! Bei mehreren openWBs ist
      ...
      <p>
        ...
        erzwingen. Gehe unter Status und vergleiche die Leistungen bzw.
        Ströme der 3 Phasen am EVU-Zähler (rot) beim und nach dem
        Autoladen (Sofortladen mit 16A/ Stop). Diejenige EVU-Phase, die
