...
import OpenwbWebThemeProxy from "../web_themes/OpenwbWebThemeProxy.vue";
import OpenwbRippleControlReceiverProxy from "../ripple_control_receivers/OpenwbRippleControlReceiverProxy.vue";
