<template>
	<div class="vehicle-soc-skodaconnect">
		<openwb-base-heading>
			Einstellungen für Skoda iV SoC
		...
		>
			<template #help>
				Der Benutzername für die Anmeldung an den SkodaConnect-Servern.
			</template>
		</openwb-base-text-input>
		<openwb-base-text-input
			title="Kennwort"
		...
		>
			<template #help>
				Das Passwort für die Anmeldung an den SkodaConnect-Servern.
			</template>
		</openwb-base-text-input>
		<openwb-base-text-input
			title="VIN"
