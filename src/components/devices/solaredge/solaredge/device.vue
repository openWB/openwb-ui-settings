<template>
  <div class="device-solaredge">
    ...
    <openwb-base-alert subtype="info">
      ...
      SolarEdge lässt nur eine ModbusTCP-Verbindung zu. Wenn Du mit einem weiteren SmartHome-System, wie z.B. ioBroker
    ...
    >
      <template #help>
        Je nach Produktionsdatum und Softwareversion ist 502 oder 1502 ab Werk eingestellt. Bitte im Wechselrichter
        überprüfen.
      </template>
    </openwb-base-number-input>
  </div>
