  ...
  <div class="device-deye">
    ...
    <openwb-base-alert subtype="info">
      <span class="text-danger">
        Deye Wechselrichter verfügen über keine Modbus-TCP Schnittstelle. Dieses Modul ermöglicht die Kommunikation über
        den LSE Dongle (LAN-Anbindung) oder einen RS485/LAN-Adapter.
      </span>
    </openwb-base-alert>
