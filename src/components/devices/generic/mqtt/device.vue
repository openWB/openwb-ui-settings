  ...
  <div class="device-mqtt">
    ...
    <openwb-base-alert subtype="info">
      <p>
        ...
        einen Punkt als Dezimaltrenner verwenden (internationales Format).
      </p>
      <p>
        Ab Version 2.1.8 wurden die Topics überarbeitet. Die bisherigen Topics openWB/set/bat/id/get/...,
        openWB/set/counter/id/get/... und openWB/set/pv/id/get/... bleiben aus Gründen der Abwärtskompatibilität
        weiterhin nutzbar. Wir empfehlen, auf die neuen Topics umzusteigen. Dies ermöglicht die Beseitigung von
