<template>
  <div class="device-generic-modbus-counter">
    <openwb-base-heading> Einstellungen für Universell Modbus Zähler </openwb-base-heading>
...
const REGISTER_SECTIONS = [
  ...
  },
  {
    ...
    title: "Spannung",
    entries: [
      { key: "voltage_L1", label: "Phase L1" },
      { key: "voltage_L2", label: "Phase L2" },
      { key: "voltage_L3", label: "Phase L3" },
    ],
  },
  {
    id: "current",
  ...
  },
  {
    ...
    title: "Leistung",
    entries: [
      { key: "powers_L1", label: "Phase L1" },
      { key: "powers_L2", label: "Phase L2" },
      { key: "powers_L3", label: "Phase L3" },
    ],
  },
  {
    id: "power_factor",
    ...
    entries: [
      { key: "power_factor_L1", label: "Phase L1" },
      { key: "power_factor_L2", label: "Phase L2" },
      { key: "power_factor_L3", label: "Phase L3" },
    ],
  },
  {
    id: "import",
...
export default {
  name: "DeviceGenericModbusCounter",
  components: {
