...
export default {
  ...
  data() {
    return {
      mqttTopics: [
        { topic: "openWB/system/security/access/Settings", writeable: false },
        { topic: "openWB/system/security/access/Status", writeable: false },
        { topic: "openWB/system/security/access/ChargeLog", writeable: false },
        { topic: "openWB/system/security/access/Chart", writeable: false },
        { topic: "openWB/system/security/access/GeneralConfiguration", writeable: false },
        { topic: "openWB/system/security/access/DisplayConfiguration", writeable: false },
        { topic: "openWB/system/security/access/IdentificationConfiguration", writeable: false },
        { topic: "openWB/system/security/access/GeneralChargeConfiguration", writeable: false },
        { topic: "openWB/system/security/access/SurplusChargeConfiguration", writeable: false },
        ...
        { topic: "openWB/system/security/access/LegacySmartHomeConfiguration", writeable: false },
        { topic: "openWB/system/security/access/InstallAssistant", writeable: false },
        { topic: "openWB/system/security/access/TenantEnergyConfiguration", writeable: false },
        { topic: "openWB/system/security/access/CloudConfiguration", writeable: false },
        { topic: "openWB/system/security/access/MqttBridgeConfiguration", writeable: false },
        { topic: "openWB/system/security/access/DebugConfiguration", writeable: false },
        { topic: "openWB/system/security/access/Support", writeable: false },
        { topic: "openWB/system/security/access/DataManagement", writeable: false },
        { topic: "openWB/system/security/access/SecurityConfiguration", writeable: false },
        { topic: "openWB/system/security/access/SystemConfiguration", writeable: false },
        { topic: "openWB/system/security/access/LegalSettings", writeable: false },
      ],
    };
  },
  computed: {
