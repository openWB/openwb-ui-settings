			...
			>
				...
				>
					...
					<openwb-base-select-input
						...
						"
						@update:model-value="
							updateState('ToDo/optional/led/pv_blocked', $event)
						"
						:options="[
							{
								value: ['off', 'off', 'off'],
					...
					<openwb-base-select-input
						...
						"
						@update:model-value="
							updateState('ToDo/optional/led/scheduled', $event)
						"
						:options="[
							{
								value: ['off', 'off', 'off'],
		...
		<openwb-base-card title="Display (intern oder extern)">
			...
			<div v-else>
				...
				>
					...
					>
						<template #help>
							Wird diese Funktion aktiviert, dann schaltet sich
				...
				<openwb-base-select-input
					...
					"
					@update:model-value="
						updateState('openWB/optional/int_display/theme', $event)
					"
					:options="[
						{
							value: 'cards',
