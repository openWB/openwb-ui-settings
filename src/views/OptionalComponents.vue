				...
				<openwb-base-card title="Identifikation von Fahrzeugen">
					...
					>
						<openwb-base-alert subtype="info">
							Weitere Einstellungen sind nicht verfügbar, solange
					...
					<div v-else>
						...
						>
							<template #help>
								Die Identifikation von Fahrzeugen kann auf
								...
								<ul>
									...
									<li>
										Durch die automatische Erkennung an
										einer openWB Pro (muss in den
										Einstellungen aktiviert werden).
									</li>
									<li>
										Durch manuelle Eingabe einer ID am
										Display einer openWB.
									</li>
								</ul>
							</template>
						</openwb-base-button-group-input>
						...
						>
							<openwb-base-alert subtype="info" class="mb-1">
								...
								Es kann zuerst das Fahrzeug angesteckt und dann
								der ID-Tag erfasst werden oder anders herum. Im
								letzten Fall muss innerhalb von 5 Minuten ein
								Fahrzeug angesteckt werden, sonst wird der
								ID-Tag verworfen. Das Fahrzeug wird erst nach
								dem Anstecken zugeordnet.<br />
							...
							>
								<template #help>
									Solange diese Seite geöffnet ist, werden
									alle erfassten ID-Tags in dieser Liste
									aufgeführt.
								</template>
							</openwb-base-textarea>
						</div>
