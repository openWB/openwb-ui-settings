<template>
  <div class="security">
    ...
    <div v-else>
      <form name="accessForm">
        <openwb-base-card title="Allgemein">
          ...
          <openwb-base-button-group-input
            ...
            :model-value="userManagementActive"
            :disabled="
            ...
            @update:model-value="userManagementActive = $event"
          >
            <template #help>
              <p>
          ...
          <openwb-base-button-input
            ...
            subtype="danger"
            :disabled="userManagementActive || loggedInUser !== null"
      ...
      <div v-if="userManagementActive && anonymousGroupName !== null">
        <openwb-base-alert
...
export default {
  ...
  data() {
    return {
      mqttTopics: [
        ...
        { topic: "openWB/optional/int_display/theme", writeable: false },
        ...
        { topic: "openWB/system/security/user_management_active", writeable: true },
      ...
      return (acls) => {
        ...
        return acls
          ...
          .map((acl) => {
            ...
            const type = aclTypes[acl.acltype] || acl.acltype;
  ...
  watch: {
    ...
    userManagementActive(newVal, oldVal) {
      if (newVal !== oldVal) {
        this.init();
      }
    },
